...
class Messages():
	...
	def __init__(self, settings, screen):
		...
		#Value for y co-ordinate for the messsages
		self.y_pos = 250
	...
	def prep_start(self):
		#Turn start msg into an image and position it slightly lower than the
		#screen's centre
	...
	def prep_game_over(self):
		#Turn game over msg into an image and position it slightly lower than
		#the screen's centre
